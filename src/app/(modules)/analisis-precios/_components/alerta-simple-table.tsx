...
// descripción y nombre comercial, sin columnas de precio/diferencia. Color
// ámbar en vez de rojo para distinguirlas de las alertas de violación de
// precio (2026-09-23).
export function AlertaSimpleTable({
  title,
  description,
  emptyMessage,
  paramPrefix,
