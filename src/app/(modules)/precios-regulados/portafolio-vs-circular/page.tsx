...
// /precios-regulados — son dos análisis separados.
export default async function PortafolioVsCircularPage({
  ...
  const nivel0: DrilldownBar[] = [
    { label: "Regulados", value: reguladosCount, fill: "#2563eb" },
    { label: "No regulados", value: totalPortafolio - reguladosCount, fill: "#94a3b8" },
  ];
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Portafolio de proveedores vs. circular 22 — {all.length} productos regulados de {totalPortafolio} en portafolio
            </p>
          </div>
        </div>
      ...
      <div className="min-w-0 rounded-xl border bg-card p-4">
        <h3 className="mb-3 text-sm font-semibold">Todos los artículos vs. regulados</h3>
      ...
      <div className="grid min-w-0 items-start gap-4 lg:grid-cols-[1.3fr_1fr]">
        <div className="min-w-0 rounded-xl border bg-card p-4">
          <h3 className="text-sm font-semibold">
            Proveedores {portafolioLabel ? `— ${portafolioLabel}` : "(todos los regulados)"}
          </h3>
